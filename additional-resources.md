...
## Gemini Notebook – Official Help & Guides

These links focus specifically on Gemini Notebook:

- [Gemini Notebook homepage](https://notebooklm.google/){:target="_blank"}  
- [Gemini Notebook Help Center](https://support.google.com/notebooklm){:target="_blank"}  
- [Google Gemini Notebook announcement and feature overview](https://blog.google/technology/ai/notebooklm/){:target="_blank"}  
...
These videos and guides show Gemini Notebook and related GenAI tools in action:

- [Basic Gemini Notebook tutorial for educators](https://www.youtube.com/watch?v=w5ZcWmAltgQ){:target="_blank"} (12 min)  
