...
In this module, you’ll use **Gemini Notebook** to transform your uploaded documents, meeting transcripts, and even videos into audience-ready summaries—and then refine, translate, and output those summaries in multiple formats.
...
- Turn one or more sources into a **study guide, FAQ, or outline** using Gemini Notebook.  
- Use **citations and source previews** to verify and correct Gemini Notebook’s summaries.
...
1. Create a new notebook in **Gemini Notebook**: from the dashboard, click **Create**.  
...
> **Pro tip:**  
> Mix formats in one notebook (PDF + webpage + slides). Later, you can ask Gemini Notebook to summarize or compare across formats as long as the sources are text-readable.
