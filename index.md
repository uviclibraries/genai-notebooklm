...
## What is Gemini Notebook and what does it do?

Gemini Notebook is Google’s AI research and study workspace. Instead of chatting with a generic model that uses the whole internet as it's source of data (both the good and the bad), you load your own sources (papers, PDFs, Docs, Sheets, web pages, videos, notes), into Gemini Notebook and it builds a “thinking partner” that stays grounded in those materials.

You can then ask questions, generate explanations, and create outputs (reports, flashcards, slide decks, infographics, audio/video overviews) that are all based on the content you provided. This makes Gemini Notebook especially useful for courses, research projects, literature reviews, and complex real-world documents.

At a high level, Gemini Notebook lets you:

- **Create notebooks** for individual courses, projects, or topics.
- **Automatically cites sources**, so you can see exactly where each answer comes from in the documents you've uploaded to Gemini Notebook.
...
1. **Describe the core capabilities of Gemini Notebook** (source-grounded Q&A, summarization, translation, and document synthesis).
