...
- Build a **Gemini Notebook** from your own sources (PDFs, Docs, webpages, etc.)  
...
- A **laptop** which you'll need for a Zoom based workshop and is recommended to use all of Gemini Notebook's features
...
This workshop consists of a small amount of instruction followed by **hands-on activities**. To be ready to jump straight into Gemini Notebook, please:
...
- [Gemini Notebook for Resaerch](https://www.youtube.com/watch?v=pHHyLQaWL5I){:target="_blank"} (9 min)<br>
...
3. (Optional) Log in once to **[Gemini Notebook](https://notebooklm.google/){:target="_blank"}** so your account is ready.
